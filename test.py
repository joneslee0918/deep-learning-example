...
if __name__ == "__main__":
    ...
    parser.add_argument("--clip_path", type=str, default="./sample_videos/clips/v05", help="path of input clips")
    parser.add_argument("--ref_path", type=str, default="./sample_videos/ref/v05", help="path of refernce images")
